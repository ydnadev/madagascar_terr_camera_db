...
st.write(
    "source data: Wampole, Erin M., Gerber, Brian D., Farris, Zach J., Razafimahaimodison, Jean Claude, Andrianarisoa, Mahandry Hugues, Ralazampirenena, Claude Jacquot, Wright, Patricia C., et al. 2022. Madagascar Terrestrial Camera Survey Database 2021: A Collation of Protected Forest Camera Surveys from 2007–2021. Ecology 103( 6): e3687. https://doi.org/10.1002/ecy.3687"
)
...
sp_filter = st.selectbox(
    "Select/Type the Species", pd.unique(df["common_name"].str.upper().sort_values())
)
